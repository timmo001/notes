...
required=(BarWidget.qml Panel.qml README.md manifest.json)
...
expected_source=(BarWidget.qml Panel.qml README.md manifest.json)
...
expected_publish=(BarWidget.qml LICENSE Panel.qml README.md manifest.json)
