...
required=(BarWidget.qml FilterablePanel.qml MultilineTextField.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml manifest.json)
...
expected_source=(BarWidget.qml FilterablePanel.qml MultilineTextField.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml manifest.json)
...
expected_publish=(BarWidget.qml FilterablePanel.qml LICENSE MultilineTextField.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml manifest.json)
