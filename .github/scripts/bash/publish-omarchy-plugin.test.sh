...
for file in BarWidget.qml FilterablePanel.qml MultilineTextField.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml manifest.json; do
